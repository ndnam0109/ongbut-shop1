                ...
                <div
                    ...
                    <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                        <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                            <h2 className="mb-3 text-sm font-semibold tracking-widest text-gray-900 uppercase title-font">Hỗ trợ khách hàng</h2>
                        ...
                        <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                            <h2 className="mb-3 text-sm font-semibold tracking-widest text-gray-900 uppercase title-font">Về taka</h2>
                            <nav className="mb-10 list-none">
                                <li className="mt-3">
                        ...
                        <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                            <h2 className="mb-3 text-sm font-semibold tracking-widest text-gray-900 uppercase title-font">Hợp tác và liên kết
                            </h2>
                            <nav className="mb-10 list-none">
                                <li className="mt-3">
                        ...
                        <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                            <h2 className="mb-3 text-sm font-semibold tracking-widest text-gray-900 uppercase title-font">Phương thức thanh toán</h2>
                            <nav className="mb-10 list-none">
                                <li className="mt-3">
